...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::agent_profile::get_agent_execution_profile,
            commands::agent_studio::list_studio_agents,
            commands::agent_studio::get_studio_agent,
            commands::agent_studio::create_studio_agent,
            commands::agent_studio::update_studio_agent,
            commands::agent_studio::delete_studio_agent,
            commands::agent_studio::resolve_studio_agent_runtime,
            commands::agent_studio::list_studio_agent_resource_catalog,
            commands::agent_team::list_agent_teams,
            commands::agent_team::create_agent_team,
            commands::agent_team::update_agent_team,
            commands::agent_team::delete_agent_team,
