...
This project is indexed by GitNexus as **easy_agent_pilot** (13829 symbols, 30184 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
