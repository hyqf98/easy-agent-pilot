export default {
  ...
  settings: {
    ...
    general: {
      ...
      miniPanelShortcutOverrideDesc: 'When the shortcut conflicts with Windows or another app, use a native keyboard hook to intercept it first.',
      ...
      miniPanelShortcutEnableOverride: 'Enable Override Mode',
      miniPanelShortcutOverrideUnsupported: 'The current build does not support Windows override mode.',
      miniPanelShortcutOverrideFailed: 'Windows override mode failed to start. Try another shortcut or restart the app.',
