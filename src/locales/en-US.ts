export default {
  ...
  messageArea: {
    welcome: {
      ...
      title: 'Import a project to get started',
  ...
  session: {
    ...
    executionError: 'Session execution error',
  ...
  settings: {
    ...
    desc: {
      ...
      agentManagement: 'Unified management of provider switching, session history and skills config',
    ...
    subAgents: {
      title: 'Sub-Agents',
      subtitle: 'Manage ACP client configs (name + prompt)',
      ...
      deleteBlocked: 'This sub-agent is still referenced: plans {plans}, tasks {tasks}, sessions {sessions}',
      deleteConfirm: 'Delete sub-agent "{name}"?',
      saveSuccess: 'Saved successfully',
      saveFailed: 'Failed to save',
      emptyUserList: 'No sub-agents yet. Click + to create one.',
      diskHint: 'Sub-agents will be written to {dir}',
      diskTitle: 'Existing sub-agents on disk (read-only)',
      diskEmpty: 'No sub-agent files found in {dir}',
      fields: {
        name: 'Name',
        prompt: 'Prompt'
      }
    ...
    usageStats: {
      ...
      todayInputCost: 'Input Cost',
      todayOutputCost: 'Output Cost',
      todayCacheHitRate: 'Cache Hit Rate',
      cacheHitRate: 'Cache Hit Rate',
      trendTitle: 'Trend',
      modelTrendTitle: 'Model Usage Trend',
      metricLabel: 'Metric',
    ...
    providerSwitch: {
      ...
      currentFileConfig: 'Configuration Info',
