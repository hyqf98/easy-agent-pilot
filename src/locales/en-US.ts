export default {
  ...
  marketplace: {
    ...
    installSkillFromGit: 'Install Skill from Git',
    installPlugin: 'Install Plugin',
    installPluginFromGit: 'Install Plugin from Git',
    ...
    gitSkillInstallHint: 'Git skills are installed into the selected CLI global skills directory.',
    gitPluginInstallHint: 'Git plugins are installed into the selected CLI global plugins directory.',
    gitRepository: 'Git Repository',
    gitRepositoryPlaceholder: 'https://github.com/example/repo.git',
    gitReference: 'Branch or Tag',
    gitReferencePlaceholder: 'Optional, e.g. main or v1.0.0',
    skillNameLabel: 'Skill Name',
    skillNamePlaceholder: 'Enter the Skill directory or frontmatter name',
    pluginNameLabel: 'Plugin Name',
    pluginNamePlaceholder: 'Enter the Plugin directory or plugin.json name',
    command: 'Command',
    args: 'Arguments',
    envVars: 'Environment Variables',
    envKey: 'Key',
