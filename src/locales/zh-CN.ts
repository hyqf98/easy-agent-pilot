...
const zhCN = {
  ...
  settings: {
    ...
    desc: {
      ...
      agentManagement: '统一管理 Provider 切换、会话记录与技能配置',
      theme: '浅色 / 深色主题与强调色配置',
    ...
    subAgents: {
      ...
      saving: '保存中...',
      duplicateSuffix: '副本',
      deleteBlocked: '该子代理仍被引用：计划 {plans}、任务 {tasks}、会话 {sessions}',
      deleteConfirm: '确认删除子代理“{name}”吗？',
      saveSuccess: '保存成功',
      saveFailed: '保存失败',
      emptyUserList: '暂无子代理，点击 + 新建',
      diskHint: '子代理将写盘到 {dir}',
      diskTitle: '磁盘已有子代理（只读）',
      diskEmpty: '{dir} 下暂无子代理文件',
      fields: {
        name: '名称',
        prompt: '提示词'
      }
    ...
    usageStats: {
      ...
      todayTotalTokens: '今日总 Token',
      todayCost: '折合价格',
      todayInputCost: '输入费用',
      todayOutputCost: '输出费用',
      todayCacheHitRate: '缓存命中率',
      cacheHitRate: '缓存命中率',
      trendTitle: '趋势变化',
      modelTrendTitle: '模型用量趋势',
      metricLabel: '指标',
