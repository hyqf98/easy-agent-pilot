...
const zhCN = {
  ...
  marketplace: {
    ...
    installSkill: '安装技能',
    installSkillFromGit: '从 Git 安装技能',
    installPlugin: '安装插件',
    installPluginFromGit: '从 Git 安装插件',
    ...
    gitRepositoryPlaceholder: 'https://github.com/example/repo.git',
    gitReference: '分支或标签',
    gitReferencePlaceholder: '可选，例如 main 或 v1.0.0',
    skillNameLabel: 'Skill 名称',
    skillNamePlaceholder: '输入 Skill 目录名或 SKILL.md 中的名称',
    pluginNameLabel: 'Plugin 名称',
    pluginNamePlaceholder: '输入 Plugin 目录名或 plugin.json 中的名称',
    command: '命令',
    args: '参数',
    envVars: '环境变量',
    envKey: '键',
