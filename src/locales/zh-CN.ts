...
const zhCN = {
  ...
  settings: {
    ...
    general: {
      ...
      miniPanelShortcutOverrideDesc: '当快捷键与 Windows 或其他应用冲突时，使用原生键盘钩子优先拦截该按键。',
      miniPanelShortcutOverrideWarning: '覆盖模式会全局拦截系统快捷键和单键输入，仅在确有冲突时再启用。',
      miniPanelShortcutEnableOverride: '启用覆盖模式',
      miniPanelShortcutOverrideUnsupported: '当前构建不支持 Windows 覆盖模式。',
      miniPanelShortcutOverrideFailed: 'Windows 覆盖模式启动失败，请尝试其他快捷键或重启应用。',
