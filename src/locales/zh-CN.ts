...
const zhCN = {
  ...
  settings: {
    ...
    usageStats: {
      ...
      todayInputTokens: '今日输入 Token',
      todayOutputTokens: '今日输出 Token',
    ...
    agent: {
      ...
      cliPathRequired: '请输入 ACP 命令',
      validation: {
        urlInvalid: 'URL 格式无效，请输入有效的 URL（如 https://api.example.com）',
        urlProtocolRequired: 'URL 必须包含协议（如 https://）',
        cliPathNotFound: 'ACP 命令不可用，请检查是否已安装并加入 PATH',
        cliPathNotExecutable: 'ACP 命令不可执行，请检查当前环境的 PATH 与权限',
        cliPathValidationFailed: 'ACP 命令校验失败'
      },
      scan: {
